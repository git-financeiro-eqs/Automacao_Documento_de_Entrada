        ...
        try:
            while cont <= controlador:
                ...
                if tem_icms == True and tem_icms_st == True and tem_ipi == True:
                    ctrl_imposto = "Todos os impostos" # 7
                elif tem_icms == True and tem_icms_st == True:
                    ctrl_imposto = "Apenas ICMS e ICMSST" # 6
                elif tem_icms == True and tem_ipi == True:
                    ctrl_imposto = "Apenas ICMS e IPI" # 5
                elif tem_icms_st == True and tem_ipi == True:
                    ctrl_imposto = "Apenas ICMSST e IPI" # 4
                elif tem_ipi == True:
                    ctrl_imposto = "Apenas o IPI" # 3
                elif tem_icms_st == True:
                    ctrl_imposto = "Apenas o ICMSST" # 2
                elif tem_icms == True:
                    ctrl_imposto = "Apenas o ICMS" # 1
                else:
                    ctrl_imposto = "Nenhum imposto" # 0
